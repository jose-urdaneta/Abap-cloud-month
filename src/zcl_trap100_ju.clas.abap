CLASS zcl_trap100_ju DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_trap100_ju IMPLEMENTATION.
...
*   clear data
    DELETE FROM ZTRAP100__JU.
    DELETE FROM ZTRAP100_JU_D.

    "insert travel demo data
    INSERT ztrap100__ju FROM (
        SELECT
